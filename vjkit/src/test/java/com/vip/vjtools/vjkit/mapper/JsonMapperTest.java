...
public class JsonMapperTest {
	...
	public void toJson() throws Exception {
		...
		assertThatJson(mapString).isEqualTo("{\"name\":\"A\",\"age\":2}");
		...
		assertThatJson(beanListString).isEqualTo(
		...
		assertThatJson(beanArrayString).isEqualTo(
				"[{\"name\":\"A\",\"defaultValue\":\"hello\",\"nullValue\":null,\"emptyValue\":[]},{\"name\":\"B\",\"defaultValue\":\"hello\",\"nullValue\":null,\"emptyValue\":[]}]");
	}
